...
public abstract class Personaje {
	...
	/**
	 * Modifica la vida actual del personaje, contrololando que no supere la vida máxima
	 * @param vidaActual
	...
	/**
	 * Modifica la vida Máxima del personaje. No puede ser inferior a la vida actual , ni superar el límite m�ximo
	 * @param vidaMaxima
	 * @throws PersonajeException
	 */
